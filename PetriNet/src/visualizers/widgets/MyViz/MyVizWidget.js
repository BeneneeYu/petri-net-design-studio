...
/**
 * Generated by VisualizerGenerator 1.7.0 from webgme on Sat Dec 03 2022 21:37:39 GMT+0000 (Coordinated Universal Time).
 */

define(["jointjs", "css!./styles/MyVizWidget.css"], function (joint) {
  "use strict";
  var WIDGET_CLASS = "my-viz";
  function MyVizWidget(logger, container) {
  ...
  MyVizWidget.prototype.initPlaces = function () {
    let self = this;
  ...
  MyVizWidget.prototype.initTransitions = function () {
    let self = this;
  ...
  MyVizWidget.prototype.turnOnEnabledTrans = function () {
    let self = this;
  ...
  MyVizWidget.prototype.initializeArcs = function (arcType) {
    let self = this;
  ...
  MyVizWidget.prototype.initNet = function (petriNetDescriptor) {
    const self = this;
  ...
  MyVizWidget.prototype.destroyNet = function () { };
  ...
  MyVizWidget.prototype.fireEvent = function (transition) {
    let self = this;
  ...
  MyVizWidget.prototype.fireTransition = function (t, sec, self) {
  ...
  MyVizWidget.prototype.resetNet = function () {
     this.initNet(this._webgmePetriNet);
  };

  MyVizWidget.prototype.createWidgetView = function () {
  ...
  MyVizWidget.prototype.createPlaceView = function () {
  ...
  MyVizWidget.prototype.createPlaceShape = function () {
  ...
  MyVizWidget.prototype.createCSS = function (labelText) {
    let _attr = {
      ".label": {
        text: labelText,
        "text-anchor": "middle",
